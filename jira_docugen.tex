[WARNING] Image jira_imgs/244.png width greater than 450 pixels.
[WARNING] Image jira_imgs/245.png width greater than 450 pixels.
[WARNING] Image jira_imgs/246.png width greater than 450 pixels.
[WARNING] Image jira_imgs/247.png width greater than 450 pixels.
[WARNING] Image jira_imgs/248.png width greater than 450 pixels.
[WARNING] Image jira_imgs/249.png width greater than 450 pixels.
[WARNING] Image jira_imgs/251.png width greater than 450 pixels.
[WARNING] Image jira_imgs/256.png width greater than 450 pixels.
[WARNING] Image jira_imgs/257.png width greater than 450 pixels.
[WARNING] Image jira_imgs/258.png width greater than 450 pixels.
[WARNING] Image jira_imgs/255.png width greater than 450 pixels.
...
this.\\
~\\
Choose columns to return by:\\
1) unchecking the top box in the column selection box\\
2) checking columns for id, coord\_ra, coord\_dec, and parent.\\
~\\
The result should look like the following:\\
\hspace*{0.333em}\\
\includegraphics[width=4.6875in,height=\textheight]{jira_imgs/244.png}\\
...
large elliptical galaxy in the Stripe 82 coverage.\\
~\\
To do this, enter the name "NGC 359" in the "Name or Position" text
input box.\\
~\\
Leave the other defaults in place.\\
~\\
\includegraphics[width=4.6875in,height=\textheight]{jira_imgs/245.png}
...
widgets.\\
~\\
\includegraphics[width=4.6875in,height=\textheight]{jira_imgs/246.png}
...
This should be updated as the system matures.\\
~\\
...
~\\
The result should look like the following:\\
\includegraphics[width=4.6875in,height=\textheight]{jira_imgs/247.png}\\
...
\includegraphics[width=4.6875in,height=\textheight]{jira_imgs/248.png}
        ...
        \\ \midrule
            ...
            \multirow{3}{*}{ 5 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            Return to the query interface by clicking the "LSST Data" button in the
upper left of the interface.
...
to "330.504167 0.250083".
        ...
        \\ \midrule
            ...
            \multirow{3}{*}{ 7 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            Execute the modified query by clicking the "Search" button at the bottom
...
just one:\\
\includegraphics[width=4.6875in,height=\textheight]{jira_imgs/249.png}
...
\subsubsection{Test Items}
Verify that the Portal aspect provides for the users a "property sheet"
for the contents of an alert packet including, but not necessarily
limited to, the alert postage stamp image, the postage stamp time
series, the photometric time series, the source and object information
...
\includegraphics[width=4.6875in,height=\textheight]{jira_imgs/251.png}
...
\includegraphics[width=4.6875in,height=\textheight]{jira_imgs/256.png}After
clicking once on "coord\_ra", it sorts by RA in ascending order:\\
\includegraphics[width=4.6875in,height=\textheight]{jira_imgs/257.png}After
clicking again on "coord\_ra", it sorts by RA in descending order:\\
\includegraphics[width=4.6875in,height=\textheight]{jira_imgs/258.png}
...
\includegraphics[width=4.6875in,height=\textheight]{jira_imgs/255.png}
...
warning.
        ...
        \\ \midrule
            ...
            \multirow{3}{*}{ 4 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            From the "File" menu, select "Save All, Exit, and Log Out" to exit the
Notebook Aspect.
...
versions for each.
                ...
                & {\small Description} &
                \begin{minipage}[t]{13cm}{\scriptsize
                Select the option under "Other" labeled "Terminal" by clicking on the
icon.
...
tab.
        ...
        \\ \midrule
            ...
            \multirow{3}{*}{ 9 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            Clear all errors by navigating the top menu bar "Kernel" -\textgreater{}
...
.bashrc".\\
~\\
Then make a change to the .bashrc file by opening it with your favorite
text editor, and adding the example code below. Save the .bashrc file.\\
~\\
Confirm that the new line is in your .bashrc file by typing "cat
.bashrc".
...
container containing the correct stack version.
        ...
        \\ \midrule
            ...
            \multirow{3}{*}{ 7 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            After logging back in, check whether your changes have been retained.\\
~\\
Open a terminal, and confirm that the message entered into your .bashrc
file prints to the screen.\\
~\\
Confirm that the temporary file you created is still present (e.g., by
typing "cat tmp.txt" and observing that the contents print to the
screen).
...
\subsubsection{Test Procedure}
    ...
    \endhead
        ...
        \\ \midrule
            ...
            \multirow{3}{*}{ 2 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            Instantiate a connection to the TAP service with the pyVO library.\\
~\\
~\\
~\\
...
table (inserting the correct table name from Step 3):\\
~\\
~\\
...
LIMIT 5")\\
results.to\_table().show\_in\_notebook()\\
~\\
 }
                \vspace{\dp0}
                } \end{minipage} \\ \cline{2-3}
...
a "reference catalog" is an externally sourced catalog used during data
...
~\\
service =
pyvo.dal.TAPService('http://lsst-lsp-stable.ncsa.illinois.edu/api/tap')\\
~\\
service.describe()\\
~\\
...
correct table name from Step 3):\\
~\\
results = service.search("SELECT * from schema.example\_table LIMIT
5")\\
results.to\_table().show\_in\_notebook()\\
~\\
~\\
...
\subsubsection{Test Procedure}
    ...
    \endhead
        ...
        \\ \midrule
            ...
            \multirow{3}{*}{ 2 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            Retrieve the TAP capabilities description by executing:\\
~\\
curl https://lsst-lsp-stable.ncsa.illinois.edu/api/tap/capabilities
...
\textless{}/outputFormat\textgreater{}\\
~\\
