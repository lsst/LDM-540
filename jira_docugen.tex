...
% using template at /opt/conda/lib/python3.7/site-packages/docsteady-1.2rc10.post1+g1a75e2a-py3.7.egg/docsteady/templates/dm-spec.latex.jinja2.
...
milestone} \tabularnewline
    ...
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1824}{LDM-503-xxx - Deployment of processed HSC data in the LSP} \tabularnewline
\bottomrule
\end{longtable}
...
\subsection{LVV-T1824 - LDM-503-xxx - Deployment of processed HSC data in the LSP}\label{lvv-t1824}
...
metadata, available through all three LSP Aspects. ~This includes
Notebook Aspect access to catalogs and images, Portal Aspect access (via
TAP) to catalogs and image metadata (ObsTAP-style) and through that to
images, and API Aspect access to catalogs, image metadata, images, and
image cutouts.\\[2\baselineskip]Access to single-epoch catalog data such
as Source or ForcedSource, and access to AP-style products, including
DIA* catalogs and difference images, are possible stretch goals, but
...
Notebook Aspect and Portal Aspect.

\paragraph{Hardware}

\subsubsection{Input Specification}
Execution of a DRP-style processing of a TBD-sized collection of HSC
data, up to the full HSC PDR2 dataset.
