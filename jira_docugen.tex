...
\endhead
    ...
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T622}{Verify LSP only available to authenticated users} &  Approved \tabularnewline
    \hyperref[lvv-t807]{LVV-T807} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T807}{Verify synchronous TAP queries} &  Approved \tabularnewline
...
milestone} &  Approved \tabularnewline
...
milestone} &  Approved \tabularnewline
    ...
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1818}{DM-SUIT-8: Verify Portal integration with workspace (via WebDAV)} &  Approved \tabularnewline
    \hyperref[lvv-t598]{LVV-T598} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T598}{Verify access to All Released or Authorized Data Products} &  Draft \tabularnewline
    \hyperref[lvv-t600]{LVV-T600} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T600}{Verify LSP provides a portal aspect} &  Draft \tabularnewline
    \hyperref[lvv-t601]{LVV-T601} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T601}{Verify LSP provides a notebook aspect} &  Draft \tabularnewline
    \hyperref[lvv-t602]{LVV-T602} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T602}{Verify LSP provides web API} &  Draft \tabularnewline
    \hyperref[lvv-t603]{LVV-T603} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T603}{Verify data access through multiple linked aspects} &  Draft \tabularnewline
    \hyperref[lvv-t604]{LVV-T604} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T604}{Verify use of VO standards} &  Draft \tabularnewline
    \hyperref[lvv-t605]{LVV-T605} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T605}{Verify that LSP complies with LSST data access policies} &  Draft \tabularnewline
    \hyperref[lvv-t606]{LVV-T606} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T606}{Verify semantic linkages between data items} &  Draft \tabularnewline
    \hyperref[lvv-t607]{LVV-T607} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T607}{Verify semantic linkages between data items and uncertainties} &  Draft \tabularnewline
    \hyperref[lvv-t608]{LVV-T608} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T608}{Verify transfer of Portal data references to Notebook aspect} &  Draft \tabularnewline
    \hyperref[lvv-t609]{LVV-T609} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T609}{Verify providing user file storage in LSP} &  Draft \tabularnewline
    \hyperref[lvv-t610]{LVV-T610} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T610}{Verify providing user generated database in LSP} &  Draft \tabularnewline
    \hyperref[lvv-t611]{LVV-T611} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T611}{Verify access controls in user workspace} &  Draft \tabularnewline
    \hyperref[lvv-t612]{LVV-T612} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T612}{Verify ability to download data from LSP} &  Draft \tabularnewline
    \hyperref[lvv-t613]{LVV-T613} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T613}{Verify ability to upload data to LSP} &  Draft \tabularnewline
    \hyperref[lvv-t614]{LVV-T614} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T614}{Verify ability to transfer data to and from the Workspace} &  Draft \tabularnewline
    \hyperref[lvv-t615]{LVV-T615} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T615}{Verify file formats provided for tabular data download} &  Draft \tabularnewline
    \hyperref[lvv-t616]{LVV-T616} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T616}{Verify file formats provided for image data download} &  Draft \tabularnewline
    \hyperref[lvv-t617]{LVV-T617} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T617}{Verify support for peak volume of moderate-sized queries} &  Draft \tabularnewline
    \hyperref[lvv-t618]{LVV-T618} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T618}{Verify support for peak volume of queries on all Objects} &  Draft \tabularnewline
    \hyperref[lvv-t619]{LVV-T619} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T619}{Verify LSP handles peak volume of queries} &  Draft \tabularnewline
    \hyperref[lvv-t620]{LVV-T620} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T620}{Verify LSP supports required download bandwidth} &  Draft \tabularnewline
    \hyperref[lvv-t621]{LVV-T621} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T621}{Verify LSP user reference and documentation} &  Draft \tabularnewline
    \hyperref[lvv-t623]{LVV-T623} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T623}{Verify support for new LSP users} &  Draft \tabularnewline
    \hyperref[lvv-t624]{LVV-T624} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T624}{Verify implementation of common identity across LSP aspects} &  Draft \tabularnewline
    \hyperref[lvv-t625]{LVV-T625} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T625}{Verify authentication via external identity providers} &  Draft \tabularnewline
    \hyperref[lvv-t626]{LVV-T626} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T626}{Verify LSP identity can have multiple associated credentials} &  Draft \tabularnewline
    \hyperref[lvv-t627]{LVV-T627} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T627}{Verify implementation of Acceptable Use Policy} &  Draft \tabularnewline
    \hyperref[lvv-t628]{LVV-T628} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T628}{Verify LSP connections encrypted} &  Draft \tabularnewline
    \hyperref[lvv-t629]{LVV-T629} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T629}{Verify privacy of users' activities} &  Draft \tabularnewline
    \hyperref[lvv-t630]{LVV-T630} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T630}{Verify multiple LSP instances} &  Draft \tabularnewline
    \hyperref[lvv-t631]{LVV-T631} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T631}{Verify LSP access from the public Internet (IPv4)} &  Draft \tabularnewline
    \hyperref[lvv-t632]{LVV-T632} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T632}{Verify LSP access from the public Internet (IPv6)} &  Draft \tabularnewline
    \hyperref[lvv-t633]{LVV-T633} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T633}{Verify indication of system availability} &  Draft \tabularnewline
    \hyperref[lvv-t634]{LVV-T634} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T634}{Verify Portal is a web application} &  Draft \tabularnewline
    \hyperref[lvv-t635]{LVV-T635} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T635}{Verify Portal discovery of all data products} &  Draft \tabularnewline
    \hyperref[lvv-t636]{LVV-T636} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T636}{Verify Portal access to Workspace} &  Draft \tabularnewline
    \hyperref[lvv-t637]{LVV-T637} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T637}{Verify Portal provides semantic linkages between data products} &  Draft \tabularnewline
    \hyperref[lvv-t638]{LVV-T638} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T638}{Verify access to calibration products via Portal} &  Draft \tabularnewline
    \hyperref[lvv-t639]{LVV-T639} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T639}{Verify associations between single images and coadds} &  Draft \tabularnewline
    \hyperref[lvv-t640]{LVV-T640} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T640}{Verify access to external archives from Portal} &  Draft \tabularnewline
    \hyperref[lvv-t641]{LVV-T641} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T641}{Verify API for Access to Portal Session State} &  Draft \tabularnewline
    \hyperref[lvv-t642]{LVV-T642} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T642}{Verify Portal supports both synchronous and asynchronous queries} &  Draft \tabularnewline
    \hyperref[lvv-t643]{LVV-T643} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T643}{Verify capability to run long queries in the background} &  Draft \tabularnewline
    \hyperref[lvv-t644]{LVV-T644} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T644}{Verify user notification of query status} &  Draft \tabularnewline
    \hyperref[lvv-t645]{LVV-T645} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T645}{Verify limitation of query results size} &  Draft \tabularnewline
    \hyperref[lvv-t646]{LVV-T646} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T646}{Verify ability to browse query history} &  Draft \tabularnewline
    \hyperref[lvv-t647]{LVV-T647} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T647}{Verify implementation of saving of queries} &  Draft \tabularnewline
    \hyperref[lvv-t648]{LVV-T648} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T648}{Verify implementation of generic queries in API aspect} &  Draft \tabularnewline
    \hyperref[lvv-t649]{LVV-T649} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T649}{Verify implementation of form-based generic query in API aspect} &  Draft \tabularnewline
    \hyperref[lvv-t650]{LVV-T650} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T650}{Verify implementation of ADQL-based generic query in API aspect} &  Draft \tabularnewline
    \hyperref[lvv-t651]{LVV-T651} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T651}{Verify estimation of query result size} &  Draft \tabularnewline
    \hyperref[lvv-t652]{LVV-T652} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T652}{Verify query by unique identifier} &  Draft \tabularnewline
    \hyperref[lvv-t653]{LVV-T653} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T653}{Verify query by object or source identifier} &  Draft \tabularnewline
    \hyperref[lvv-t654]{LVV-T654} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T654}{Verify query by Solar System object identifier} &  Draft \tabularnewline
    \hyperref[lvv-t655]{LVV-T655} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T655}{Verify query by position on the sky} &  Draft \tabularnewline
    \hyperref[lvv-t656]{LVV-T656} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T656}{Verify query by list of positions} &  Draft \tabularnewline
    \hyperref[lvv-t657]{LVV-T657} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T657}{Verify implementation of astrophysical coordinate systems} &  Draft \tabularnewline
    \hyperref[lvv-t658]{LVV-T658} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T658}{Verify positional query by astrophysical source name} &  Draft \tabularnewline
    \hyperref[lvv-t659]{LVV-T659} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T659}{Verify positional query by Source or Object name} &  Draft \tabularnewline
    \hyperref[lvv-t660]{LVV-T660} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T660}{Verify positional query based on Solar System object names} &  Draft \tabularnewline
    \hyperref[lvv-t661]{LVV-T661} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T661}{Verify query by cone search} &  Draft \tabularnewline
    \hyperref[lvv-t662]{LVV-T662} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T662}{Verify query by box search} &  Draft \tabularnewline
    \hyperref[lvv-t663]{LVV-T663} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T663}{Verify query by time of observation} &  Draft \tabularnewline
    \hyperref[lvv-t664]{LVV-T664} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T664}{Verify implementation of user-friendly tabular query} &  Draft \tabularnewline
    \hyperref[lvv-t666]{LVV-T666} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T666}{Verify query by image metadata} &  Draft \tabularnewline
    \hyperref[lvv-t667]{LVV-T667} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T667}{Verify queries on the alerts database} &  Draft \tabularnewline
    \hyperref[lvv-t668]{LVV-T668} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T668}{Verify access to original alert state} &  Draft \tabularnewline
    \hyperref[lvv-t669]{LVV-T669} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T669}{Verify query for single-epoch visit images} &  Draft \tabularnewline
    \hyperref[lvv-t670]{LVV-T670} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T670}{Verify query for single-epoch raft images} &  Draft \tabularnewline
    \hyperref[lvv-t671]{LVV-T671} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T671}{Verify query for single-epoch CCD images} &  Draft \tabularnewline
    \hyperref[lvv-t672]{LVV-T672} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T672}{Verify metadata query for single-epoch images} &  Draft \tabularnewline
    \hyperref[lvv-t673]{LVV-T673} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T673}{Verify query for coadds by image metadata} &  Draft \tabularnewline
    \hyperref[lvv-t674]{LVV-T674} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T674}{Verify query for coadd image cutouts} &  Draft \tabularnewline
    \hyperref[lvv-t675]{LVV-T675} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T675}{Verify query for single-epoch image cutouts} &  Draft \tabularnewline
    \hyperref[lvv-t676]{LVV-T676} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T676}{Verify display of native single-visit images} &  Draft \tabularnewline
    \hyperref[lvv-t677]{LVV-T677} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T677}{Verify Portal provides visualization of tabular and image data} &  Draft \tabularnewline
    \hyperref[lvv-t678]{LVV-T678} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T678}{Verify visualization of ancillary information} &  Draft \tabularnewline
    \hyperref[lvv-t679]{LVV-T679} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T679}{Verify visualization linking image and tabular data} &  Draft \tabularnewline
    \hyperref[lvv-t680]{LVV-T680} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T680}{Verify visualization tool for uploaded tabular or image data} &  Draft \tabularnewline
    \hyperref[lvv-t681]{LVV-T681} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T681}{Verify visualization of workspace data} &  Draft \tabularnewline
    \hyperref[lvv-t682]{LVV-T682} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T682}{Verify availability of property sheets for table rows} &  Draft \tabularnewline
    \hyperref[lvv-t683]{LVV-T683} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T683}{Verify visualization of alerts} &  Draft \tabularnewline
    \hyperref[lvv-t684]{LVV-T684} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T684}{Verify display of tabular data} &  Draft \tabularnewline
    \hyperref[lvv-t685]{LVV-T685} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T685}{Verify column selection from tables} &  Draft \tabularnewline
    \hyperref[lvv-t686]{LVV-T686} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T686}{Verify capability to re-order columns in displayed tabular data} &  Draft \tabularnewline
    \hyperref[lvv-t687]{LVV-T687} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T687}{Verify capability of copying data in tables} &  Draft \tabularnewline
    \hyperref[lvv-t688]{LVV-T688} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T688}{Verify row selection from tables} &  Draft \tabularnewline
    \hyperref[lvv-t689]{LVV-T689} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T689}{Verify capability to display tabular data in paged format} &  Draft \tabularnewline
    \hyperref[lvv-t690]{LVV-T690} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T690}{Verify creation and display of X-Y scatter plots} &  Draft \tabularnewline
    \hyperref[lvv-t691]{LVV-T691} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T691}{Verify creation and display of histogram plots} &  Draft \tabularnewline
...
scatter plots} &  Draft \tabularnewline
    \hyperref[lvv-t693]{LVV-T693} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T693}{Verify visualization of uncertainties in plots} &  Draft \tabularnewline
    \hyperref[lvv-t694]{LVV-T694} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T694}{Verify visualization of asymmetric uncertainties} &  Draft \tabularnewline
    \hyperref[lvv-t695]{LVV-T695} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T695}{Verify visualization of upper and lower limits in plots} &  Draft \tabularnewline
    \hyperref[lvv-t696]{LVV-T696} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T696}{Verify visualization of multiple XY plots on the same display} &  Draft \tabularnewline
    \hyperref[lvv-t697]{LVV-T697} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T697}{Verify display of raft and full focal-plane single-visit images} &  Draft \tabularnewline
    \hyperref[lvv-t698]{LVV-T698} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T698}{Verify display of cutout from single-visit image} &  Draft \tabularnewline
    \hyperref[lvv-t699]{LVV-T699} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T699}{Verify display of native coadd images} &  Draft \tabularnewline
    \hyperref[lvv-t700]{LVV-T700} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T700}{Verify display of coadd cutouts and mosaics} &  Draft \tabularnewline
    \hyperref[lvv-t701]{LVV-T701} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T701}{Verify display of calibration images} &  Draft \tabularnewline
    \hyperref[lvv-t702]{LVV-T702} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T702}{Verify display of user-provided images} &  Draft \tabularnewline
    \hyperref[lvv-t703]{LVV-T703} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T703}{Verify display of image property sheet} &  Draft \tabularnewline
    \hyperref[lvv-t704]{LVV-T704} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T704}{Verify that coordinate display tools are provided for images} &  Draft \tabularnewline
    \hyperref[lvv-t705]{LVV-T705} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T705}{Verify image pixel content display} &  Draft \tabularnewline
    \hyperref[lvv-t706]{LVV-T706} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T706}{Verify spatial manipulation of images} &  Draft \tabularnewline
    \hyperref[lvv-t707]{LVV-T707} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T707}{Verify multi-image scaling and alignment} &  Draft \tabularnewline
    \hyperref[lvv-t708]{LVV-T708} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T708}{Verify manipulation of image appearance} &  Draft \tabularnewline
    \hyperref[lvv-t709]{LVV-T709} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T709}{Verify display of image mask and variance overlays} &  Draft \tabularnewline
    \hyperref[lvv-t710]{LVV-T710} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T710}{Verify display of plot overlays on images} &  Draft \tabularnewline
    \hyperref[lvv-t711]{LVV-T711} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T711}{Verify capability to adjust the appearance of plot overlays on images} &  Draft \tabularnewline
    \hyperref[lvv-t712]{LVV-T712} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T712}{Verify display all-sky HEALPix image} &  Draft \tabularnewline
    \hyperref[lvv-t713]{LVV-T713} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T713}{Verify ability to zoom in/out on a HEALPix image} &  Draft \tabularnewline
    \hyperref[lvv-t714]{LVV-T714} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T714}{Verify panning in HEALPix image display} &  Draft \tabularnewline
    \hyperref[lvv-t715]{LVV-T715} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T715}{Verify selection of HEALPix pixels} &  Draft \tabularnewline
    \hyperref[lvv-t716]{LVV-T716} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T716}{Verify retrieval of HEALPix-associated data} &  Draft \tabularnewline
    \hyperref[lvv-t717]{LVV-T717} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T717}{Verify broad applicability of coordinate display} &  Draft \tabularnewline
    \hyperref[lvv-t718]{LVV-T718} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T718}{Verify point coordinate display} &  Draft \tabularnewline
    \hyperref[lvv-t719]{LVV-T719} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T719}{Verify distance measurement tool} &  Draft \tabularnewline
    \hyperref[lvv-t720]{LVV-T720} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T720}{Verify coordinate grid overlays} &  Draft \tabularnewline
    \hyperref[lvv-t721]{LVV-T721} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T721}{Verify astrophysical compass overlay} &  Draft \tabularnewline
    \hyperref[lvv-t722]{LVV-T722} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T722}{Verify geometric figure overlays} &  Draft \tabularnewline
    \hyperref[lvv-t723]{LVV-T723} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T723}{Verify sorting of tabular data by column} &  Draft \tabularnewline
    \hyperref[lvv-t724]{LVV-T724} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T724}{Verify simple filtering of tabular data} &  Draft \tabularnewline
    \hyperref[lvv-t725]{LVV-T725} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T725}{Verify calculated filtering of tabular data} &  Draft \tabularnewline
    \hyperref[lvv-t726]{LVV-T726} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T726}{Verify filtering data by multiple table columns} &  Draft \tabularnewline
    \hyperref[lvv-t727]{LVV-T727} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T727}{Verify calculated tabular data columns} &  Draft \tabularnewline
    \hyperref[lvv-t728]{LVV-T728} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T728}{Verify statistical measurements on tabular data} &  Draft \tabularnewline
    \hyperref[lvv-t729]{LVV-T729} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T729}{Verify saving of displayed tabular data} &  Draft \tabularnewline
    \hyperref[lvv-t730]{LVV-T730} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T730}{Verify creation and display of false-color images} &  Draft \tabularnewline
    \hyperref[lvv-t731]{LVV-T731} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T731}{Verify statistical measurements on user-selected regions of images} &  Draft \tabularnewline
    \hyperref[lvv-t732]{LVV-T732} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T732}{Verify overlay of catalog sources/objects on images} &  Draft \tabularnewline
    \hyperref[lvv-t733]{LVV-T733} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T733}{Verify overlay of LSST-derived orbits on images} &  Draft \tabularnewline
    \hyperref[lvv-t734]{LVV-T734} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T734}{Verify overlay of user-supplied catalogs on images} &  Draft \tabularnewline
    \hyperref[lvv-t735]{LVV-T735} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T735}{Verify overlay of user-supplied region files on images} &  Draft \tabularnewline
    \hyperref[lvv-t736]{LVV-T736} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T736}{Verify overlay of camera artifacts on images} &  Draft \tabularnewline
    \hyperref[lvv-t737]{LVV-T737} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T737}{Verify single-object time-domain image view} &  Draft \tabularnewline
    \hyperref[lvv-t738]{LVV-T738} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T738}{Verify position-based time-domain image view} &  Draft \tabularnewline
    \hyperref[lvv-t739]{LVV-T739} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T739}{Verify display of light curves} &  Draft \tabularnewline
    \hyperref[lvv-t740]{LVV-T740} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T740}{Verify linked tables, plots, and images} &  Draft \tabularnewline
    \hyperref[lvv-t741]{LVV-T741} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T741}{Verify capability to select data from a plot or image} &  Draft \tabularnewline
    \hyperref[lvv-t742]{LVV-T742} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T742}{Verify saving data selection from a plot or image} &  Draft \tabularnewline
    \hyperref[lvv-t743]{LVV-T743} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T743}{Verify access to user databases} &  Draft \tabularnewline
    \hyperref[lvv-t744]{LVV-T744} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T744}{Verify tabular data download} &  Draft \tabularnewline
    \hyperref[lvv-t745]{LVV-T745} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T745}{Verify image data download} &  Draft \tabularnewline
    \hyperref[lvv-t746]{LVV-T746} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T746}{Verify selected image download} &  Draft \tabularnewline
    \hyperref[lvv-t747]{LVV-T747} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T747}{Verify estimation of data download volume} &  Draft \tabularnewline
    \hyperref[lvv-t748]{LVV-T748} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T748}{Verify notification of long download completion} &  Draft \tabularnewline
    \hyperref[lvv-t749]{LVV-T749} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T749}{Verify API for visualization components} &  Draft \tabularnewline
    \hyperref[lvv-t750]{LVV-T750} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T750}{Verify implementation of storage quotas status} &  Draft \tabularnewline
    \hyperref[lvv-t751]{LVV-T751} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T751}{Verify implementation of computational quotas status} &  Draft \tabularnewline
    \hyperref[lvv-t752]{LVV-T752} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T752}{Verify saved Portal display preferences} &  Draft \tabularnewline
    \hyperref[lvv-t753]{LVV-T753} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T753}{Verify alert subscription service} &  Draft \tabularnewline
    \hyperref[lvv-t754]{LVV-T754} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T754}{Verify availability of pre-defined alert filters} &  Draft \tabularnewline
    \hyperref[lvv-t755]{LVV-T755} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T755}{Verify availability of user-defined alert filters} &  Draft \tabularnewline
    \hyperref[lvv-t756]{LVV-T756} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T756}{Verify monitoring of alert subscription} &  Draft \tabularnewline
    \hyperref[lvv-t757]{LVV-T757} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T757}{Verify access to survey documentation} &  Draft \tabularnewline
    \hyperref[lvv-t758]{LVV-T758} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T758}{Verify access to Portal documentation} &  Draft \tabularnewline
    \hyperref[lvv-t759]{LVV-T759} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T759}{Verify access to Portal API documentation} &  Draft \tabularnewline
    \hyperref[lvv-t760]{LVV-T760} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T760}{Verify tolerance of database changes} &  Draft \tabularnewline
    \hyperref[lvv-t761]{LVV-T761} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T761}{Verify implementation of system-busy notification} &  Draft \tabularnewline
    \hyperref[lvv-t762]{LVV-T762} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T762}{Verify availability of interactive Python environment} &  Draft \tabularnewline
    \hyperref[lvv-t763]{LVV-T763} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T763}{Verify availability of Unix shell access} &  Draft \tabularnewline
    \hyperref[lvv-t764]{LVV-T764} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T764}{Verify availability of containerized software releases} &  Draft \tabularnewline
    \hyperref[lvv-t765]{LVV-T765} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T765}{Verify latency of release deployment} &  Draft \tabularnewline
    \hyperref[lvv-t766]{LVV-T766} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T766}{Verify availability of data access middleware} &  Draft \tabularnewline
    \hyperref[lvv-t767]{LVV-T767} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T767}{Verify availability of standard astronomy software} &  Draft \tabularnewline
    \hyperref[lvv-t768]{LVV-T768} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T768}{Verify availability of user package installation} &  Draft \tabularnewline
    \hyperref[lvv-t769]{LVV-T769} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T769}{Verify availability of user development environment} &  Draft \tabularnewline
    \hyperref[lvv-t770]{LVV-T770} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T770}{Verify availability of persistent user home file space} &  Draft \tabularnewline
    \hyperref[lvv-t771]{LVV-T771} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T771}{Verify availability of Notebook aspect documentation} &  Draft \tabularnewline
    \hyperref[lvv-t772]{LVV-T772} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T772}{Verify new-user onboarding} &  Draft \tabularnewline
    \hyperref[lvv-t773]{LVV-T773} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T773}{Verify availability of shared file space} &  Draft \tabularnewline
    \hyperref[lvv-t774]{LVV-T774} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T774}{Verify API and Portal aspects accessible from Notebook} &  Draft \tabularnewline
    \hyperref[lvv-t775]{LVV-T775} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T775}{Verify access to User File Workspace} &  Draft \tabularnewline
    \hyperref[lvv-t776]{LVV-T776} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T776}{Verify access to VOSpace services from Notebook aspect} &  Draft \tabularnewline
    \hyperref[lvv-t777]{LVV-T777} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T777}{Verify user database workspace access from Notebook aspect} &  Draft \tabularnewline
    \hyperref[lvv-t778]{LVV-T778} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T778}{Verify access to batch system} &  Draft \tabularnewline
    \hyperref[lvv-t779]{LVV-T779} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T779}{Verify implementation of quotas in Notebook aspect} &  Draft \tabularnewline
    \hyperref[lvv-t780]{LVV-T780} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T780}{Verify access to all data products from Notebook aspect} &  Draft \tabularnewline
    \hyperref[lvv-t781]{LVV-T781} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T781}{Verify ease of Notebook aspect deployment} &  Draft \tabularnewline
    \hyperref[lvv-t782]{LVV-T782} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T782}{Verify workload for deployment in Kubernetes} &  Draft \tabularnewline
    \hyperref[lvv-t783]{LVV-T783} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T783}{Verify monitoring of Notebook system health} &  Draft \tabularnewline
    \hyperref[lvv-t784]{LVV-T784} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T784}{Verify visualization of images in Notebook aspect} &  Draft \tabularnewline
    \hyperref[lvv-t785]{LVV-T785} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T785}{Verify availability of scientific plotting tools in Notebook aspect} &  Draft \tabularnewline
    \hyperref[lvv-t786]{LVV-T786} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T786}{Verify linkage of visualization tools in Notebook aspect} &  Draft \tabularnewline
    \hyperref[lvv-t787]{LVV-T787} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T787}{Verify interactivity of visualizations in Notebook aspect} &  Draft \tabularnewline
    \hyperref[lvv-t788]{LVV-T788} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T788}{Verify interactive scaling of visualizations in Notebook aspect} &  Draft \tabularnewline
    \hyperref[lvv-t789]{LVV-T789} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T789}{Verify access to Portal queries from Notebook aspect} &  Draft \tabularnewline
    \hyperref[lvv-t790]{LVV-T790} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T790}{Verify access to Portal visualization API from Notebook aspect} &  Draft \tabularnewline
    \hyperref[lvv-t791]{LVV-T791} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T791}{Verify ability to launch a notebook with access to Portal query results} &  Draft \tabularnewline
    \hyperref[lvv-t792]{LVV-T792} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T792}{Verify implementation of secure protocol for Notebook aspect} &  Draft \tabularnewline
...
Notebook aspect} &  Draft \tabularnewline
    \hyperref[lvv-t794]{LVV-T794} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T794}{Verify secure implementation of Notebook aspect} &  Draft \tabularnewline
    \hyperref[lvv-t795]{LVV-T795} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T795}{Verify access to Notebook aspect via IPv6} &  Draft \tabularnewline
    \hyperref[lvv-t796]{LVV-T796} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T796}{Verify web APIs use CAOM2} &  Draft \tabularnewline
    \hyperref[lvv-t797]{LVV-T797} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T797}{Verify API access to image and visit metadata} &  Draft \tabularnewline
    \hyperref[lvv-t798]{LVV-T798} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T798}{Verify API access to catalog data products} &  Draft \tabularnewline
    \hyperref[lvv-t799]{LVV-T799} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T799}{Verify API access to observatory metadata} &  Draft \tabularnewline
    \hyperref[lvv-t800]{LVV-T800} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T800}{Verify API enforcement of information classification} &  Draft \tabularnewline
    \hyperref[lvv-t801]{LVV-T801} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T801}{Verify API access to reference catalogs} &  Draft \tabularnewline
    \hyperref[lvv-t802]{LVV-T802} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T802}{Verify API access to virtual data products} &  Draft \tabularnewline
    \hyperref[lvv-t803]{LVV-T803} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T803}{Verify API access to FITS image data} &  Draft \tabularnewline
    \hyperref[lvv-t804]{LVV-T804} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T804}{Verify API access to multiple data releases} &  Draft \tabularnewline
    \hyperref[lvv-t805]{LVV-T805} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T805}{Verify API provides catalog metadata} &  Draft \tabularnewline
    \hyperref[lvv-t806]{LVV-T806} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T806}{Verify availability of TAP service} &  Draft \tabularnewline
    \hyperref[lvv-t808]{LVV-T808} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T808}{Verify asynchronous TAP queries} &  Draft \tabularnewline
    \hyperref[lvv-t809]{LVV-T809} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T809}{Verify availability of ADQL for queries} &  Draft \tabularnewline
    \hyperref[lvv-t810]{LVV-T810} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T810}{Verify SIA service for image availability} &  Draft \tabularnewline
    \hyperref[lvv-t811]{LVV-T811} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T811}{Verify availability of SODA service for image data} &  Draft \tabularnewline
    \hyperref[lvv-t812]{LVV-T812} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T812}{Verify API SODA cutout image support} &  Draft \tabularnewline
    \hyperref[lvv-t813]{LVV-T813} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T813}{Verify query history retrieval} &  Draft \tabularnewline
    \hyperref[lvv-t814]{LVV-T814} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T814}{Verify availability of cached query result retrieval} &  Draft \tabularnewline
    \hyperref[lvv-t815]{LVV-T815} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T815}{Verify retrieval of query specifications} &  Draft \tabularnewline
    \hyperref[lvv-t816]{LVV-T816} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T816}{Verify Butler interface to data products} &  Draft \tabularnewline
    \hyperref[lvv-t817]{LVV-T817} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T817}{Verify availability of VOSpace service} &  Draft \tabularnewline
    \hyperref[lvv-t818]{LVV-T818} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T818}{Verify availability of WebDAV service} &  Draft \tabularnewline
    \hyperref[lvv-t819]{LVV-T819} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T819}{Verify VOTable 1.3 support} &  Draft \tabularnewline
    \hyperref[lvv-t820]{LVV-T820} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T820}{Verify support for VOTable TABLEDATA payload} &  Draft \tabularnewline
    \hyperref[lvv-t821]{LVV-T821} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T821}{Verify support for VOTable BINARY2 payload} &  Draft \tabularnewline
    \hyperref[lvv-t822]{LVV-T822} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T822}{Verify JSON support for TAP outputs} &  Draft \tabularnewline
    \hyperref[lvv-t823]{LVV-T823} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T823}{Verify CSV support for TAP outputs} &  Draft \tabularnewline
    \hyperref[lvv-t824]{LVV-T824} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T824}{Verify SQLite support for TAP outputs} &  Draft \tabularnewline
    \hyperref[lvv-t825]{LVV-T825} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T825}{Verify support for tabular result download to Workspace} &  Draft \tabularnewline
    \hyperref[lvv-t826]{LVV-T826} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T826}{Verify support for tabular upload to Workspace} &  Draft \tabularnewline
    \hyperref[lvv-t827]{LVV-T827} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T827}{Verify ability to drop catalogs from Workspace} &  Draft \tabularnewline
    \hyperref[lvv-t828]{LVV-T828} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T828}{Verify API uses secure protocols} &  Draft \tabularnewline
    \hyperref[lvv-t829]{LVV-T829} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T829}{Verify API authentication} &  Draft \tabularnewline
    \hyperref[lvv-t830]{LVV-T830} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T830}{Verify API uses project authorization infrastructure} &  Draft \tabularnewline
    \hyperref[lvv-t831]{LVV-T831} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T831}{Verify secure implementation of APIs} &  Draft \tabularnewline
    \hyperref[lvv-t832]{LVV-T832} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T832}{Verify containerized deployment of API services} &  Draft \tabularnewline
    \hyperref[lvv-t833]{LVV-T833} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T833}{Verify support for compression of API results} &  Draft \tabularnewline
    \hyperref[lvv-t834]{LVV-T834} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T834}{Verify API upgradeability} &  Draft \tabularnewline
    \hyperref[lvv-t835]{LVV-T835} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T835}{Verify API logging and monitoring} &  Draft \tabularnewline
    \hyperref[lvv-t1824]{LVV-T1824} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1824}{Portal Aspect access to processed HSC data in the LSP} &  Draft \tabularnewline
    \hyperref[lvv-t1825]{LVV-T1825} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1825}{Notebook Aspect access to processed HSC data in the LSP} &  Draft \tabularnewline
\bottomrule
\end{longtable}
...
\subsubsection{LVV-T622 - Verify LSP only available to authenticated users}\label{lvv-t622}
...
\subsubsection{LVV-T807 - Verify synchronous TAP queries}\label{lvv-t807}
...
\toprule
Step 1-1
{\scriptsize from \hyperref[lvv-t1591]{LVV-T1591} }
& Description \\ \hline
\end{tabular}
{\scriptsize
...
\subsubsection{LVV-T1334 - LDM-503-10a: Portal Aspect tests for LSP with Authentication and TAP
...
\subsubsection{LVV-T1436 - LDM-503-10a: Notebook Aspect tests for LSP with Authentication and TAP
...
\subsubsection{LVV-T1437 - LDM-503-10a: API Aspect tests for LSP with Authentication and TAP
...
\subsubsection{LVV-T1818 - DM-SUIT-8: Verify Portal integration with workspace (via WebDAV)}\label{lvv-t1818}
...
\subsubsection{LVV-T598 - Verify access to All Released or Authorized Data Products}\label{lvv-t598}
...
\subsubsection{LVV-T600 - Verify LSP provides a portal aspect}\label{lvv-t600}
...
\subsubsection{LVV-T601 - Verify LSP provides a notebook aspect}\label{lvv-t601}
...
\subsubsection{LVV-T602 - Verify LSP provides web API}\label{lvv-t602}
...
\subsubsection{LVV-T603 - Verify data access through multiple linked aspects}\label{lvv-t603}
...
\subsubsection{LVV-T604 - Verify use of VO standards}\label{lvv-t604}
...
\subsubsection{LVV-T605 - Verify that LSP complies with LSST data access policies}\label{lvv-t605}
...
\subsubsection{LVV-T606 - Verify semantic linkages between data items}\label{lvv-t606}
...
\subsubsection{LVV-T607 - Verify semantic linkages between data items and uncertainties}\label{lvv-t607}
...
\subsubsection{LVV-T608 - Verify transfer of Portal data references to Notebook aspect}\label{lvv-t608}
...
\subsubsection{LVV-T609 - Verify providing user file storage in LSP}\label{lvv-t609}
...
\subsubsection{LVV-T610 - Verify providing user generated database in LSP}\label{lvv-t610}
...
\subsubsection{LVV-T611 - Verify access controls in user workspace}\label{lvv-t611}
...
\subsubsection{LVV-T612 - Verify ability to download data from LSP}\label{lvv-t612}
...
\subsubsection{LVV-T613 - Verify ability to upload data to LSP}\label{lvv-t613}
...
\subsubsection{LVV-T614 - Verify ability to transfer data to and from the Workspace}\label{lvv-t614}
...
\subsubsection{LVV-T615 - Verify file formats provided for tabular data download}\label{lvv-t615}
...
\subsubsection{LVV-T616 - Verify file formats provided for image data download}\label{lvv-t616}
...
\subsubsection{LVV-T617 - Verify support for peak volume of moderate-sized queries}\label{lvv-t617}
...
\subsubsection{LVV-T618 - Verify support for peak volume of queries on all Objects}\label{lvv-t618}
...
\subsubsection{LVV-T619 - Verify LSP handles peak volume of queries}\label{lvv-t619}
...
\subsubsection{LVV-T620 - Verify LSP supports required download bandwidth}\label{lvv-t620}
...
\subsubsection{LVV-T621 - Verify LSP user reference and documentation}\label{lvv-t621}
...
\subsubsection{LVV-T623 - Verify support for new LSP users}\label{lvv-t623}
...
\subsubsection{LVV-T624 - Verify implementation of common identity across LSP aspects}\label{lvv-t624}
...
\subsubsection{LVV-T625 - Verify authentication via external identity providers}\label{lvv-t625}
...
\subsubsection{LVV-T626 - Verify LSP identity can have multiple associated credentials}\label{lvv-t626}
...
\subsubsection{LVV-T627 - Verify implementation of Acceptable Use Policy}\label{lvv-t627}
...
\subsubsection{LVV-T628 - Verify LSP connections encrypted}\label{lvv-t628}
...
\subsubsection{LVV-T629 - Verify privacy of users' activities}\label{lvv-t629}
...
\subsubsection{LVV-T630 - Verify multiple LSP instances}\label{lvv-t630}
...
\subsubsection{LVV-T631 - Verify LSP access from the public Internet (IPv4)}\label{lvv-t631}
...
\subsubsection{LVV-T632 - Verify LSP access from the public Internet (IPv6)}\label{lvv-t632}
...
\subsubsection{LVV-T633 - Verify indication of system availability}\label{lvv-t633}
...
\subsubsection{LVV-T634 - Verify Portal is a web application}\label{lvv-t634}
...
\subsubsection{LVV-T635 - Verify Portal discovery of all data products}\label{lvv-t635}
...
\subsubsection{LVV-T636 - Verify Portal access to Workspace}\label{lvv-t636}
...
\subsubsection{LVV-T637 - Verify Portal provides semantic linkages between data products}\label{lvv-t637}
...
\subsubsection{LVV-T638 - Verify access to calibration products via Portal}\label{lvv-t638}
...
\subsubsection{LVV-T639 - Verify associations between single images and coadds}\label{lvv-t639}
...
\subsubsection{LVV-T640 - Verify access to external archives from Portal}\label{lvv-t640}
...
\subsubsection{LVV-T641 - Verify API for Access to Portal Session State}\label{lvv-t641}
...
\subsubsection{LVV-T642 - Verify Portal supports both synchronous and asynchronous queries}\label{lvv-t642}
...
\subsubsection{LVV-T643 - Verify capability to run long queries in the background}\label{lvv-t643}
...
\subsubsection{LVV-T644 - Verify user notification of query status}\label{lvv-t644}
...
\subsubsection{LVV-T645 - Verify limitation of query results size}\label{lvv-t645}
...
\subsubsection{LVV-T646 - Verify ability to browse query history}\label{lvv-t646}
...
\subsubsection{LVV-T647 - Verify implementation of saving of queries}\label{lvv-t647}
...
\subsubsection{LVV-T648 - Verify implementation of generic queries in API aspect}\label{lvv-t648}
...
\subsubsection{LVV-T649 - Verify implementation of form-based generic query in API aspect}\label{lvv-t649}
...
\subsubsection{LVV-T650 - Verify implementation of ADQL-based generic query in API aspect}\label{lvv-t650}
...
\subsubsection{LVV-T651 - Verify estimation of query result size}\label{lvv-t651}
...
\subsubsection{LVV-T652 - Verify query by unique identifier}\label{lvv-t652}
...
\subsubsection{LVV-T653 - Verify query by object or source identifier}\label{lvv-t653}
...
\subsubsection{LVV-T654 - Verify query by Solar System object identifier}\label{lvv-t654}
...
\subsubsection{LVV-T655 - Verify query by position on the sky}\label{lvv-t655}
...
\subsubsection{LVV-T656 - Verify query by list of positions}\label{lvv-t656}
...
\subsubsection{LVV-T657 - Verify implementation of astrophysical coordinate systems}\label{lvv-t657}
...
\subsubsection{LVV-T658 - Verify positional query by astrophysical source name}\label{lvv-t658}
...
\toprule
Step 2-1
{\scriptsize from \hyperref[lvv-t851]{LVV-T851} }
& Description \\ \hline
\end{tabular}
{\scriptsize
...
\subsubsection{LVV-T659 - Verify positional query by Source or Object name}\label{lvv-t659}
...
\subsubsection{LVV-T660 - Verify positional query based on Solar System object names}\label{lvv-t660}
...
\subsubsection{LVV-T661 - Verify query by cone search}\label{lvv-t661}
...
\subsubsection{LVV-T662 - Verify query by box search}\label{lvv-t662}
...
\subsubsection{LVV-T663 - Verify query by time of observation}\label{lvv-t663}
...
\subsubsection{LVV-T664 - Verify implementation of user-friendly tabular query}\label{lvv-t664}
...
\subsubsection{LVV-T666 - Verify query by image metadata}\label{lvv-t666}
...
\subsubsection{LVV-T667 - Verify queries on the alerts database}\label{lvv-t667}
...
\subsubsection{LVV-T668 - Verify access to original alert state}\label{lvv-t668}
...
\subsubsection{LVV-T669 - Verify query for single-epoch visit images}\label{lvv-t669}
...
\subsubsection{LVV-T670 - Verify query for single-epoch raft images}\label{lvv-t670}
...
\subsubsection{LVV-T671 - Verify query for single-epoch CCD images}\label{lvv-t671}
...
\subsubsection{LVV-T672 - Verify metadata query for single-epoch images}\label{lvv-t672}
...
\subsubsection{LVV-T673 - Verify query for coadds by image metadata}\label{lvv-t673}
...
\subsubsection{LVV-T674 - Verify query for coadd image cutouts}\label{lvv-t674}
...
\subsubsection{LVV-T675 - Verify query for single-epoch image cutouts}\label{lvv-t675}
...
\subsubsection{LVV-T676 - Verify display of native single-visit images}\label{lvv-t676}
...
\subsubsection{LVV-T677 - Verify Portal provides visualization of tabular and image data}\label{lvv-t677}
...
\subsubsection{LVV-T678 - Verify visualization of ancillary information}\label{lvv-t678}
...
\subsubsection{LVV-T679 - Verify visualization linking image and tabular data}\label{lvv-t679}
...
\subsubsection{LVV-T680 - Verify visualization tool for uploaded tabular or image data}\label{lvv-t680}
...
\subsubsection{LVV-T681 - Verify visualization of workspace data}\label{lvv-t681}
...
\subsubsection{LVV-T682 - Verify availability of property sheets for table rows}\label{lvv-t682}
...
\subsubsection{LVV-T683 - Verify visualization of alerts}\label{lvv-t683}
...
\subsubsection{LVV-T684 - Verify display of tabular data}\label{lvv-t684}
...
\subsubsection{LVV-T685 - Verify column selection from tables}\label{lvv-t685}
...
\subsubsection{LVV-T686 - Verify capability to re-order columns in displayed tabular data}\label{lvv-t686}
...
\subsubsection{LVV-T687 - Verify capability of copying data in tables}\label{lvv-t687}
...
\subsubsection{LVV-T688 - Verify row selection from tables}\label{lvv-t688}
...
\subsubsection{LVV-T689 - Verify capability to display tabular data in paged format}\label{lvv-t689}
...
\subsubsection{LVV-T690 - Verify creation and display of X-Y scatter plots}\label{lvv-t690}
...
\subsubsection{LVV-T691 - Verify creation and display of histogram plots}\label{lvv-t691}
...
\subsubsection{LVV-T692 - Verify capability to change symbol shapes, sizes, and colors in XY(Z)
...
\subsubsection{LVV-T693 - Verify visualization of uncertainties in plots}\label{lvv-t693}
...
\subsubsection{LVV-T694 - Verify visualization of asymmetric uncertainties}\label{lvv-t694}
...
\subsubsection{LVV-T695 - Verify visualization of upper and lower limits in plots}\label{lvv-t695}
...
\subsubsection{LVV-T696 - Verify visualization of multiple XY plots on the same display}\label{lvv-t696}
...
\subsubsection{LVV-T697 - Verify display of raft and full focal-plane single-visit images}\label{lvv-t697}
...
\subsubsection{LVV-T698 - Verify display of cutout from single-visit image}\label{lvv-t698}
...
\subsubsection{LVV-T699 - Verify display of native coadd images}\label{lvv-t699}
...
\subsubsection{LVV-T700 - Verify display of coadd cutouts and mosaics}\label{lvv-t700}
...
\subsubsection{LVV-T701 - Verify display of calibration images}\label{lvv-t701}
...
\subsubsection{LVV-T702 - Verify display of user-provided images}\label{lvv-t702}
...
\subsubsection{LVV-T703 - Verify display of image property sheet}\label{lvv-t703}
...
\subsubsection{LVV-T704 - Verify that coordinate display tools are provided for images}\label{lvv-t704}
...
\subsubsection{LVV-T705 - Verify image pixel content display}\label{lvv-t705}
...
\subsubsection{LVV-T706 - Verify spatial manipulation of images}\label{lvv-t706}
...
\subsubsection{LVV-T707 - Verify multi-image scaling and alignment}\label{lvv-t707}
...
\subsubsection{LVV-T708 - Verify manipulation of image appearance}\label{lvv-t708}
...
\subsubsection{LVV-T709 - Verify display of image mask and variance overlays}\label{lvv-t709}
...
\subsubsection{LVV-T710 - Verify display of plot overlays on images}\label{lvv-t710}
...
\subsubsection{LVV-T711 - Verify capability to adjust the appearance of plot overlays on images}\label{lvv-t711}
...
\subsubsection{LVV-T712 - Verify display all-sky HEALPix image}\label{lvv-t712}
...
\subsubsection{LVV-T713 - Verify ability to zoom in/out on a HEALPix image}\label{lvv-t713}
...
\subsubsection{LVV-T714 - Verify panning in HEALPix image display}\label{lvv-t714}
...
\subsubsection{LVV-T715 - Verify selection of HEALPix pixels}\label{lvv-t715}
...
\subsubsection{LVV-T716 - Verify retrieval of HEALPix-associated data}\label{lvv-t716}
...
\subsubsection{LVV-T717 - Verify broad applicability of coordinate display}\label{lvv-t717}
...
\subsubsection{LVV-T718 - Verify point coordinate display}\label{lvv-t718}
...
\subsubsection{LVV-T719 - Verify distance measurement tool}\label{lvv-t719}
...
\subsubsection{LVV-T720 - Verify coordinate grid overlays}\label{lvv-t720}
...
\subsubsection{LVV-T721 - Verify astrophysical compass overlay}\label{lvv-t721}
...
\subsubsection{LVV-T722 - Verify geometric figure overlays}\label{lvv-t722}
...
\subsubsection{LVV-T723 - Verify sorting of tabular data by column}\label{lvv-t723}
...
\subsubsection{LVV-T724 - Verify simple filtering of tabular data}\label{lvv-t724}
...
\subsubsection{LVV-T725 - Verify calculated filtering of tabular data}\label{lvv-t725}
...
\subsubsection{LVV-T726 - Verify filtering data by multiple table columns}\label{lvv-t726}
...
\subsubsection{LVV-T727 - Verify calculated tabular data columns}\label{lvv-t727}
...
\subsubsection{LVV-T728 - Verify statistical measurements on tabular data}\label{lvv-t728}
...
\subsubsection{LVV-T729 - Verify saving of displayed tabular data}\label{lvv-t729}
...
\subsubsection{LVV-T730 - Verify creation and display of false-color images}\label{lvv-t730}
...
\subsubsection{LVV-T731 - Verify statistical measurements on user-selected regions of images}\label{lvv-t731}
...
\subsubsection{LVV-T732 - Verify overlay of catalog sources/objects on images}\label{lvv-t732}
...
\subsubsection{LVV-T733 - Verify overlay of LSST-derived orbits on images}\label{lvv-t733}
...
\subsubsection{LVV-T734 - Verify overlay of user-supplied catalogs on images}\label{lvv-t734}
...
\subsubsection{LVV-T735 - Verify overlay of user-supplied region files on images}\label{lvv-t735}
...
\subsubsection{LVV-T736 - Verify overlay of camera artifacts on images}\label{lvv-t736}
...
\subsubsection{LVV-T737 - Verify single-object time-domain image view}\label{lvv-t737}
...
\subsubsection{LVV-T738 - Verify position-based time-domain image view}\label{lvv-t738}
...
\subsubsection{LVV-T739 - Verify display of light curves}\label{lvv-t739}
...
\subsubsection{LVV-T740 - Verify linked tables, plots, and images}\label{lvv-t740}
...
\subsubsection{LVV-T741 - Verify capability to select data from a plot or image}\label{lvv-t741}
...
\subsubsection{LVV-T742 - Verify saving data selection from a plot or image}\label{lvv-t742}
...
\subsubsection{LVV-T743 - Verify access to user databases}\label{lvv-t743}
...
\subsubsection{LVV-T744 - Verify tabular data download}\label{lvv-t744}
...
\subsubsection{LVV-T745 - Verify image data download}\label{lvv-t745}
...
\subsubsection{LVV-T746 - Verify selected image download}\label{lvv-t746}
...
\subsubsection{LVV-T747 - Verify estimation of data download volume}\label{lvv-t747}
...
\subsubsection{LVV-T748 - Verify notification of long download completion}\label{lvv-t748}
...
\subsubsection{LVV-T749 - Verify API for visualization components}\label{lvv-t749}
...
\subsubsection{LVV-T750 - Verify implementation of storage quotas status}\label{lvv-t750}
...
\subsubsection{LVV-T751 - Verify implementation of computational quotas status}\label{lvv-t751}
...
\subsubsection{LVV-T752 - Verify saved Portal display preferences}\label{lvv-t752}
...
\subsubsection{LVV-T753 - Verify alert subscription service}\label{lvv-t753}
...
\subsubsection{LVV-T754 - Verify availability of pre-defined alert filters}\label{lvv-t754}
...
\subsubsection{LVV-T755 - Verify availability of user-defined alert filters}\label{lvv-t755}
...
\subsubsection{LVV-T756 - Verify monitoring of alert subscription}\label{lvv-t756}
...
\subsubsection{LVV-T757 - Verify access to survey documentation}\label{lvv-t757}
...
\subsubsection{LVV-T758 - Verify access to Portal documentation}\label{lvv-t758}
...
\subsubsection{LVV-T759 - Verify access to Portal API documentation}\label{lvv-t759}
...
\subsubsection{LVV-T760 - Verify tolerance of database changes}\label{lvv-t760}
...
\subsubsection{LVV-T761 - Verify implementation of system-busy notification}\label{lvv-t761}
...
\subsubsection{LVV-T762 - Verify availability of interactive Python environment}\label{lvv-t762}
...
\subsubsection{LVV-T763 - Verify availability of Unix shell access}\label{lvv-t763}
...
\toprule
Step 2-1
{\scriptsize from \hyperref[lvv-t839]{LVV-T839} }
& Description \\ \hline
\end{tabular}
{\scriptsize
Open a new launcher by navigating in the top menu bar ``File''
...
\subsubsection{LVV-T764 - Verify availability of containerized software releases}\label{lvv-t764}
...
\subsubsection{LVV-T765 - Verify latency of release deployment}\label{lvv-t765}
...
\subsubsection{LVV-T766 - Verify availability of data access middleware}\label{lvv-t766}
...
\subsubsection{LVV-T767 - Verify availability of standard astronomy software}\label{lvv-t767}
...
\subsubsection{LVV-T768 - Verify availability of user package installation}\label{lvv-t768}
...
\subsubsection{LVV-T769 - Verify availability of user development environment}\label{lvv-t769}
...
\subsubsection{LVV-T770 - Verify availability of persistent user home file space}\label{lvv-t770}
...
\subsubsection{LVV-T771 - Verify availability of Notebook aspect documentation}\label{lvv-t771}
...
\subsubsection{LVV-T772 - Verify new-user onboarding}\label{lvv-t772}
...
\subsubsection{LVV-T773 - Verify availability of shared file space}\label{lvv-t773}
...
\subsubsection{LVV-T774 - Verify API and Portal aspects accessible from Notebook}\label{lvv-t774}
...
\subsubsection{LVV-T775 - Verify access to User File Workspace}\label{lvv-t775}
...
\subsubsection{LVV-T776 - Verify access to VOSpace services from Notebook aspect}\label{lvv-t776}
...
\subsubsection{LVV-T777 - Verify user database workspace access from Notebook aspect}\label{lvv-t777}
...
\subsubsection{LVV-T778 - Verify access to batch system}\label{lvv-t778}
...
\subsubsection{LVV-T779 - Verify implementation of quotas in Notebook aspect}\label{lvv-t779}
...
\subsubsection{LVV-T780 - Verify access to all data products from Notebook aspect}\label{lvv-t780}
...
\subsubsection{LVV-T781 - Verify ease of Notebook aspect deployment}\label{lvv-t781}
...
\subsubsection{LVV-T782 - Verify workload for deployment in Kubernetes}\label{lvv-t782}
...
\subsubsection{LVV-T783 - Verify monitoring of Notebook system health}\label{lvv-t783}
...
\subsubsection{LVV-T784 - Verify visualization of images in Notebook aspect}\label{lvv-t784}
...
\subsubsection{LVV-T785 - Verify availability of scientific plotting tools in Notebook aspect}\label{lvv-t785}
...
\subsubsection{LVV-T786 - Verify linkage of visualization tools in Notebook aspect}\label{lvv-t786}
...
\subsubsection{LVV-T787 - Verify interactivity of visualizations in Notebook aspect}\label{lvv-t787}
...
\subsubsection{LVV-T788 - Verify interactive scaling of visualizations in Notebook aspect}\label{lvv-t788}
...
\subsubsection{LVV-T789 - Verify access to Portal queries from Notebook aspect}\label{lvv-t789}
...
\subsubsection{LVV-T790 - Verify access to Portal visualization API from Notebook aspect}\label{lvv-t790}
...
\subsubsection{LVV-T791 - Verify ability to launch a notebook with access to Portal query results}\label{lvv-t791}
...
\subsubsection{LVV-T792 - Verify implementation of secure protocol for Notebook aspect}\label{lvv-t792}
...
\subsubsection{LVV-T793 - Verify implementation of authentication and authorization service in
...
\subsubsection{LVV-T794 - Verify secure implementation of Notebook aspect}\label{lvv-t794}
...
\subsubsection{LVV-T795 - Verify access to Notebook aspect via IPv6}\label{lvv-t795}
...
\subsubsection{LVV-T796 - Verify web APIs use CAOM2}\label{lvv-t796}
...
\subsubsection{LVV-T797 - Verify API access to image and visit metadata}\label{lvv-t797}
...
\subsubsection{LVV-T798 - Verify API access to catalog data products}\label{lvv-t798}
...
\subsubsection{LVV-T799 - Verify API access to observatory metadata}\label{lvv-t799}
...
\subsubsection{LVV-T800 - Verify API enforcement of information classification}\label{lvv-t800}
...
\subsubsection{LVV-T801 - Verify API access to reference catalogs}\label{lvv-t801}
...
\subsubsection{LVV-T802 - Verify API access to virtual data products}\label{lvv-t802}
...
\subsubsection{LVV-T803 - Verify API access to FITS image data}\label{lvv-t803}
...
\subsubsection{LVV-T804 - Verify API access to multiple data releases}\label{lvv-t804}
...
\subsubsection{LVV-T805 - Verify API provides catalog metadata}\label{lvv-t805}
...
\subsubsection{LVV-T806 - Verify availability of TAP service}\label{lvv-t806}
...
\subsubsection{LVV-T808 - Verify asynchronous TAP queries}\label{lvv-t808}
...
\subsubsection{LVV-T809 - Verify availability of ADQL for queries}\label{lvv-t809}
...
\subsubsection{LVV-T810 - Verify SIA service for image availability}\label{lvv-t810}
...
\subsubsection{LVV-T811 - Verify availability of SODA service for image data}\label{lvv-t811}
...
\subsubsection{LVV-T812 - Verify API SODA cutout image support}\label{lvv-t812}
...
\subsubsection{LVV-T813 - Verify query history retrieval}\label{lvv-t813}
...
\subsubsection{LVV-T814 - Verify availability of cached query result retrieval}\label{lvv-t814}
...
\subsubsection{LVV-T815 - Verify retrieval of query specifications}\label{lvv-t815}
...
\subsubsection{LVV-T816 - Verify Butler interface to data products}\label{lvv-t816}
...
\subsubsection{LVV-T817 - Verify availability of VOSpace service}\label{lvv-t817}
...
\subsubsection{LVV-T818 - Verify availability of WebDAV service}\label{lvv-t818}
...
\subsubsection{LVV-T819 - Verify VOTable 1.3 support}\label{lvv-t819}
...
\subsubsection{LVV-T820 - Verify support for VOTable TABLEDATA payload}\label{lvv-t820}
...
\subsubsection{LVV-T821 - Verify support for VOTable BINARY2 payload}\label{lvv-t821}
...
\subsubsection{LVV-T822 - Verify JSON support for TAP outputs}\label{lvv-t822}
...
\subsubsection{LVV-T823 - Verify CSV support for TAP outputs}\label{lvv-t823}
...
\subsubsection{LVV-T824 - Verify SQLite support for TAP outputs}\label{lvv-t824}
...
\subsubsection{LVV-T825 - Verify support for tabular result download to Workspace}\label{lvv-t825}
...
\subsubsection{LVV-T826 - Verify support for tabular upload to Workspace}\label{lvv-t826}
...
\subsubsection{LVV-T827 - Verify ability to drop catalogs from Workspace}\label{lvv-t827}
...
\subsubsection{LVV-T828 - Verify API uses secure protocols}\label{lvv-t828}
...
\subsubsection{LVV-T829 - Verify API authentication}\label{lvv-t829}
...
\subsubsection{LVV-T830 - Verify API uses project authorization infrastructure}\label{lvv-t830}
...
\subsubsection{LVV-T831 - Verify secure implementation of APIs}\label{lvv-t831}
...
\subsubsection{LVV-T832 - Verify containerized deployment of API services}\label{lvv-t832}
...
\subsubsection{LVV-T833 - Verify support for compression of API results}\label{lvv-t833}
...
\subsubsection{LVV-T834 - Verify API upgradeability}\label{lvv-t834}
...
\subsubsection{LVV-T835 - Verify API logging and monitoring}\label{lvv-t835}
...
\subsubsection{LVV-T1824 - Portal Aspect access to processed HSC data in the LSP}\label{lvv-t1824}
...
\subsubsection{LVV-T1825 - Notebook Aspect access to processed HSC data in the LSP}\label{lvv-t1825}
