...
milestone} \tabularnewline
    ...
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1818}{DM-DAX-8: Verify Portal integration with workspace (via WebDAV)} \tabularnewline
\bottomrule
\end{longtable}
...
\subsection{LVV-T1818 - DM-DAX-8: Verify Portal integration with workspace (via WebDAV)}\label{lvv-t1818}
