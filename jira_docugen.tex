...
pyvo.dal.TAPService('https://lsst-lsp-stable.ncsa.illinois.edu/api/tap')\\[2\baselineskip]service.describe()\\[2\baselineskip]
...
table (inserting the correct table name from Step
3):\\[2\baselineskip]results = service.search(``SELECT * from
DRP\_schema.example\_DRP\_table LIMIT 5'')\\
