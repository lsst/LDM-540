...
\endhead
    ...
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T692}{Verify capability to change symbol shapes, sizes, and colors in XY(Z) scatter plots} \tabularnewline
    ...
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T793}{Verify implementation of authentication and authorization service in Notebook aspect} \tabularnewline
    ...
    \hyperref[lvv-t836]{LVV-T836} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T836}{Validate ability to identify cool dwarfs via cross-matched survey datasets in LSP} \tabularnewline
    \hyperref[lvv-t844]{LVV-T844} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T844}{Validate separation of stars and galaxies using the Notebook Aspect} \tabularnewline
    \hyperref[lvv-t845]{LVV-T845} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T845}{Validate separation of stars and galaxies using the Portal Aspect} \tabularnewline
\bottomrule
\end{longtable}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T634}{LVV-T634}
    - Verify Portal is a web application}\label{lvv-t634}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T635}{LVV-T635}
    - Verify Portal discovery of all data products}\label{lvv-t635}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T636}{LVV-T636}
    - Verify Portal access to Workspace}\label{lvv-t636}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T637}{LVV-T637}
    - Verify Portal provides semantic linkages between data products}\label{lvv-t637}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T638}{LVV-T638}
    - Verify access to calibration products via Portal}\label{lvv-t638}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T639}{LVV-T639}
    - Verify associations between single images and coadds}\label{lvv-t639}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T640}{LVV-T640}
    - Verify access to external archives from Portal}\label{lvv-t640}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T641}{LVV-T641}
    - Verify API for Access to Portal Session State}\label{lvv-t641}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T642}{LVV-T642}
    - Verify Portal supports both synchronous and asynchronous queries}\label{lvv-t642}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T643}{LVV-T643}
    - Verify capability to run long queries in the background}\label{lvv-t643}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T644}{LVV-T644}
    - Verify user notification of query status}\label{lvv-t644}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T645}{LVV-T645}
    - Verify limitation of query results size}\label{lvv-t645}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T646}{LVV-T646}
    - Verify ability to browse query history}\label{lvv-t646}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T647}{LVV-T647}
    - Verify implementation of saving of queries}\label{lvv-t647}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T648}{LVV-T648}
    - Verify implementation of generic queries in API aspect}\label{lvv-t648}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T649}{LVV-T649}
    - Verify implementation of form-based generic query in API aspect}\label{lvv-t649}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T650}{LVV-T650}
    - Verify implementation of ADQL-based generic query in API aspect}\label{lvv-t650}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T651}{LVV-T651}
    - Verify estimation of query result size}\label{lvv-t651}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T652}{LVV-T652}
    - Verify query by unique identifier}\label{lvv-t652}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T653}{LVV-T653}
    - Verify query by object or source identifier}\label{lvv-t653}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T654}{LVV-T654}
    - Verify query by Solar System object identifier}\label{lvv-t654}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T655}{LVV-T655}
    - Verify query by position on the sky}\label{lvv-t655}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T656}{LVV-T656}
    - Verify query by list of positions}\label{lvv-t656}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T657}{LVV-T657}
    - Verify implementation of astrophysical coordinate systems}\label{lvv-t657}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T658}{LVV-T658}
    - Verify positional query by astrophysical source name}\label{lvv-t658}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T659}{LVV-T659}
    - Verify positional query by Source or Object name}\label{lvv-t659}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T660}{LVV-T660}
    - Verify positional query based on Solar System object names}\label{lvv-t660}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T661}{LVV-T661}
    - Verify query by cone search}\label{lvv-t661}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T662}{LVV-T662}
    - Verify query by box search}\label{lvv-t662}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T663}{LVV-T663}
    - Verify query by time of observation}\label{lvv-t663}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T664}{LVV-T664}
    - Verify implementation of user-friendly tabular query}\label{lvv-t664}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T666}{LVV-T666}
    - Verify query by image metadata}\label{lvv-t666}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T667}{LVV-T667}
    - Verify queries on the alerts database}\label{lvv-t667}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T676}{LVV-T676}
    - Verify display of native single-visit images}\label{lvv-t676}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T677}{LVV-T677}
    - Verify Portal provides visualization of tabular and image data}\label{lvv-t677}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T678}{LVV-T678}
    - Verify visualization of ancillary information}\label{lvv-t678}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T679}{LVV-T679}
    - Verify visualization linking image and tabular data}\label{lvv-t679}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T680}{LVV-T680}
    - Verify visualization tool for uploaded tabular or image data}\label{lvv-t680}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T681}{LVV-T681}
    - Verify visualization of workspace data}\label{lvv-t681}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T682}{LVV-T682}
    - Verify availability of property sheets for table rows}\label{lvv-t682}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T683}{LVV-T683}
    - Verify visualization of alerts}\label{lvv-t683}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T684}{LVV-T684}
    - Verify display of tabular data}\label{lvv-t684}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T685}{LVV-T685}
    - Verify column selection from tables}\label{lvv-t685}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T686}{LVV-T686}
    - Verify capability to re-order columns in displayed tabular data}\label{lvv-t686}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T687}{LVV-T687}
    - Verify capability of copying data in tables}\label{lvv-t687}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T688}{LVV-T688}
    - Verify row selection from tables}\label{lvv-t688}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T689}{LVV-T689}
    - Verify capability to display tabular data in paged format}\label{lvv-t689}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T690}{LVV-T690}
    - Verify creation and display of X-Y scatter plots}\label{lvv-t690}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T691}{LVV-T691}
    - Verify creation and display of histogram plots}\label{lvv-t691}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T692}{LVV-T692}
    - Verify capability to change symbol shapes, sizes, and colors in XY(Z) scatter plots}\label{lvv-t692}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T693}{LVV-T693}
    - Verify visualization of uncertainties in plots}\label{lvv-t693}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T694}{LVV-T694}
    - Verify visualization of asymmetric uncertainties}\label{lvv-t694}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T695}{LVV-T695}
    - Verify visualization of upper and lower limits in plots}\label{lvv-t695}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T696}{LVV-T696}
    - Verify visualization of multiple XY plots on the same display}\label{lvv-t696}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T697}{LVV-T697}
    - Verify display of raft and full focal-plane single-visit images}\label{lvv-t697}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T698}{LVV-T698}
    - Verify display of cutout from single-visit image}\label{lvv-t698}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T699}{LVV-T699}
    - Verify display of native coadd images}\label{lvv-t699}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T700}{LVV-T700}
    - Verify display of coadd cutouts and mosaics}\label{lvv-t700}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T701}{LVV-T701}
    - Verify display of calibration images}\label{lvv-t701}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T702}{LVV-T702}
    - Verify display of user-provided images}\label{lvv-t702}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T703}{LVV-T703}
    - Verify display of image property sheet}\label{lvv-t703}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T704}{LVV-T704}
    - Verify that coordinate display tools are provided for images}\label{lvv-t704}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T705}{LVV-T705}
    - Verify image pixel content display}\label{lvv-t705}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T706}{LVV-T706}
    - Verify spatial manipulation of images}\label{lvv-t706}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T707}{LVV-T707}
    - Verify multi-image scaling and alignment}\label{lvv-t707}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T708}{LVV-T708}
    - Verify manipulation of image appearance}\label{lvv-t708}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T709}{LVV-T709}
    - Verify display of image mask and variance overlays}\label{lvv-t709}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T710}{LVV-T710}
    - Verify display of plot overlays on images}\label{lvv-t710}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T711}{LVV-T711}
    - Verify capability to adjust the appearance of plot overlays on images}\label{lvv-t711}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T712}{LVV-T712}
    - Verify display all-sky HEALPix image}\label{lvv-t712}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T713}{LVV-T713}
    - Verify ability to zoom in/out on a HEALPix image}\label{lvv-t713}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T714}{LVV-T714}
    - Verify panning in HEALPix image display}\label{lvv-t714}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T715}{LVV-T715}
    - Verify selection of HEALPix pixels}\label{lvv-t715}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T716}{LVV-T716}
    - Verify retrieval of HEALPix-associated data}\label{lvv-t716}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T717}{LVV-T717}
    - Verify broad applicability of coordinate display}\label{lvv-t717}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T718}{LVV-T718}
    - Verify point coordinate display}\label{lvv-t718}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T719}{LVV-T719}
    - Verify distance measurement tool}\label{lvv-t719}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T720}{LVV-T720}
    - Verify coordinate grid overlays}\label{lvv-t720}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T721}{LVV-T721}
    - Verify astrophysical compass overlay}\label{lvv-t721}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T722}{LVV-T722}
    - Verify geometric figure overlays}\label{lvv-t722}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T723}{LVV-T723}
    - Verify sorting of tabular data by column}\label{lvv-t723}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T724}{LVV-T724}
    - Verify simple filtering of tabular data}\label{lvv-t724}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T725}{LVV-T725}
    - Verify calculated filtering of tabular data}\label{lvv-t725}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T726}{LVV-T726}
    - Verify filtering data by multiple table columns}\label{lvv-t726}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T727}{LVV-T727}
    - Verify calculated tabular data columns}\label{lvv-t727}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T728}{LVV-T728}
    - Verify statistical measurements on tabular data}\label{lvv-t728}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T729}{LVV-T729}
    - Verify saving of displayed tabular data}\label{lvv-t729}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T730}{LVV-T730}
    - Verify creation and display of false-color images}\label{lvv-t730}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T731}{LVV-T731}
    - Verify statistical measurements on user-selected regions of images}\label{lvv-t731}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T732}{LVV-T732}
    - Verify overlay of catalog sources/objects on images}\label{lvv-t732}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T733}{LVV-T733}
    - Verify overlay of LSST-derived orbits on images}\label{lvv-t733}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T734}{LVV-T734}
    - Verify overlay of user-supplied catalogs on images}\label{lvv-t734}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T735}{LVV-T735}
    - Verify overlay of user-supplied region files on images}\label{lvv-t735}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T736}{LVV-T736}
    - Verify overlay of camera artifacts on images}\label{lvv-t736}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T737}{LVV-T737}
    - Verify single-object time-domain image view}\label{lvv-t737}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T738}{LVV-T738}
    - Verify position-based time-domain image view}\label{lvv-t738}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T739}{LVV-T739}
    - Verify display of light curves}\label{lvv-t739}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T740}{LVV-T740}
    - Verify linked tables, plots, and images}\label{lvv-t740}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T741}{LVV-T741}
    - Verify capability to select data from a plot or image}\label{lvv-t741}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T742}{LVV-T742}
    - Verify saving data selection from a plot or image}\label{lvv-t742}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T743}{LVV-T743}
    - Verify access to user databases}\label{lvv-t743}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T744}{LVV-T744}
    - Verify tabular data download}\label{lvv-t744}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T745}{LVV-T745}
    - Verify image data download}\label{lvv-t745}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T746}{LVV-T746}
    - Verify selected image download}\label{lvv-t746}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T747}{LVV-T747}
    - Verify estimation of data download volume}\label{lvv-t747}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T748}{LVV-T748}
    - Verify notification of long download completion}\label{lvv-t748}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T749}{LVV-T749}
    - Verify API for visualization components}\label{lvv-t749}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T750}{LVV-T750}
    - Verify implementation of storage quotas status}\label{lvv-t750}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T751}{LVV-T751}
    - Verify implementation of computational quotas status}\label{lvv-t751}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T752}{LVV-T752}
    - Verify saved Portal display preferences}\label{lvv-t752}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T753}{LVV-T753}
    - Verify alert subscription service}\label{lvv-t753}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T754}{LVV-T754}
    - Verify availability of pre-defined alert filters}\label{lvv-t754}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T755}{LVV-T755}
    - Verify availability of user-defined alert filters}\label{lvv-t755}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T756}{LVV-T756}
    - Verify monitoring of alert subscription}\label{lvv-t756}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T757}{LVV-T757}
    - Verify access to survey documentation}\label{lvv-t757}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T758}{LVV-T758}
    - Verify access to Portal documentation}\label{lvv-t758}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T759}{LVV-T759}
    - Verify access to Portal API documentation}\label{lvv-t759}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T760}{LVV-T760}
    - Verify tolerance of database changes}\label{lvv-t760}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T761}{LVV-T761}
    - Verify implementation of system-busy notification}\label{lvv-t761}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T762}{LVV-T762}
    - Verify availability of interactive Python environment}\label{lvv-t762}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T763}{LVV-T763}
    - Verify availability of Unix shell access}\label{lvv-t763}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T764}{LVV-T764}
    - Verify availability of containerized software releases}\label{lvv-t764}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T765}{LVV-T765}
    - Verify latency of release deployment}\label{lvv-t765}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T766}{LVV-T766}
    - Verify availability of data access middleware}\label{lvv-t766}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T767}{LVV-T767}
    - Verify availability of standard astronomy software}\label{lvv-t767}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T768}{LVV-T768}
    - Verify availability of user package installation}\label{lvv-t768}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T769}{LVV-T769}
    - Verify availability of user development environment}\label{lvv-t769}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T770}{LVV-T770}
    - Verify availability of persistent user home file space}\label{lvv-t770}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T771}{LVV-T771}
    - Verify availability of Notebook aspect documentation}\label{lvv-t771}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T772}{LVV-T772}
    - Verify new-user onboarding}\label{lvv-t772}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T773}{LVV-T773}
    - Verify availability of shared file space}\label{lvv-t773}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T774}{LVV-T774}
    - Verify API and Portal aspects accessible from Notebook}\label{lvv-t774}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T775}{LVV-T775}
    - Verify access to User File Workspace}\label{lvv-t775}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T776}{LVV-T776}
    - Verify access to VOSpace services from Notebook aspect}\label{lvv-t776}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T777}{LVV-T777}
    - Verify user database workspace access from Notebook aspect}\label{lvv-t777}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T778}{LVV-T778}
    - Verify access to batch system}\label{lvv-t778}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T779}{LVV-T779}
    - Verify implementation of quotas in Notebook aspect}\label{lvv-t779}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T780}{LVV-T780}
    - Verify access to all data products from Notebook aspect}\label{lvv-t780}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T781}{LVV-T781}
    - Verify ease of Notebook aspect deployment}\label{lvv-t781}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T782}{LVV-T782}
    - Verify workload for deployment in Kubernetes}\label{lvv-t782}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T783}{LVV-T783}
    - Verify monitoring of Notebook system health}\label{lvv-t783}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T784}{LVV-T784}
    - Verify visualization of images in Notebook aspect}\label{lvv-t784}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T785}{LVV-T785}
    - Verify availability of scientific plotting tools in Notebook aspect}\label{lvv-t785}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T786}{LVV-T786}
    - Verify linkage of visualization tools in Notebook aspect}\label{lvv-t786}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T787}{LVV-T787}
    - Verify interactivity of visualizations in Notebook aspect}\label{lvv-t787}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T788}{LVV-T788}
    - Verify interactive scaling of visualizations in Notebook aspect}\label{lvv-t788}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T789}{LVV-T789}
    - Verify access to Portal queries from Notebook aspect}\label{lvv-t789}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T790}{LVV-T790}
    - Verify access to Portal visualization API from Notebook aspect}\label{lvv-t790}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T791}{LVV-T791}
    - Verify ability to launch a notebook with access to Portal query results}\label{lvv-t791}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T792}{LVV-T792}
    - Verify implementation of secure protocol for Notebook aspect}\label{lvv-t792}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T793}{LVV-T793}
    - Verify implementation of authentication and authorization service in Notebook aspect}\label{lvv-t793}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T794}{LVV-T794}
    - Verify secure implementation of Notebook aspect}\label{lvv-t794}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T795}{LVV-T795}
    - Verify access to Notebook aspect via IPv6}\label{lvv-t795}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T796}{LVV-T796}
    - Verify web APIs use CAOM2}\label{lvv-t796}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T797}{LVV-T797}
    - Verify API access to image and visit metadata}\label{lvv-t797}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T798}{LVV-T798}
    - Verify API access to catalog data products}\label{lvv-t798}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T799}{LVV-T799}
    - Verify API access to observatory metadata}\label{lvv-t799}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T800}{LVV-T800}
    - Verify API enforcement of information classification}\label{lvv-t800}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T801}{LVV-T801}
    - Verify API access to reference catalogs}\label{lvv-t801}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T802}{LVV-T802}
    - Verify API access to virtual data products}\label{lvv-t802}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T803}{LVV-T803}
    - Verify API access to FITS image data}\label{lvv-t803}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T804}{LVV-T804}
    - Verify API access to multiple data releases}\label{lvv-t804}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T805}{LVV-T805}
    - Verify API provides catalog metadata}\label{lvv-t805}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T806}{LVV-T806}
    - Verify availability of TAP service}\label{lvv-t806}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T807}{LVV-T807}
    - Verify synchronous TAP queries}\label{lvv-t807}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T808}{LVV-T808}
    - Verify asynchronous TAP queries}\label{lvv-t808}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T809}{LVV-T809}
    - Verify availability of ADQL for queries}\label{lvv-t809}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T810}{LVV-T810}
    - Verify SIA service for image availability}\label{lvv-t810}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T811}{LVV-T811}
    - Verify availability of SODA service for image data}\label{lvv-t811}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T812}{LVV-T812}
    - Verify API SODA cutout image support}\label{lvv-t812}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T813}{LVV-T813}
    - Verify query history retrieval}\label{lvv-t813}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T814}{LVV-T814}
    - Verify availability of cached query result retrieval}\label{lvv-t814}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T815}{LVV-T815}
    - Verify retrieval of query specifications}\label{lvv-t815}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T816}{LVV-T816}
    - Verify Butler interface to data products}\label{lvv-t816}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T817}{LVV-T817}
    - Verify availability of VOSpace service}\label{lvv-t817}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T818}{LVV-T818}
    - Verify availability of WebDAV service}\label{lvv-t818}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T819}{LVV-T819}
    - Verify VOTable 1.3 support}\label{lvv-t819}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T820}{LVV-T820}
    - Verify support for VOTable TABLEDATA payload}\label{lvv-t820}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T821}{LVV-T821}
    - Verify support for VOTable BINARY2 payload}\label{lvv-t821}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T822}{LVV-T822}
    - Verify JSON support for TAP outputs}\label{lvv-t822}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T823}{LVV-T823}
    - Verify CSV support for TAP outputs}\label{lvv-t823}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T824}{LVV-T824}
    - Verify SQLite support for TAP outputs}\label{lvv-t824}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T825}{LVV-T825}
    - Verify support for tabular result download to Workspace}\label{lvv-t825}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T826}{LVV-T826}
    - Verify support for tabular upload to Workspace}\label{lvv-t826}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T827}{LVV-T827}
    - Verify ability to drop catalogs from Workspace}\label{lvv-t827}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T828}{LVV-T828}
    - Verify API uses secure protocols}\label{lvv-t828}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T829}{LVV-T829}
    - Verify API authentication}\label{lvv-t829}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T830}{LVV-T830}
    - Verify API uses project authorization infrastructure}\label{lvv-t830}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T831}{LVV-T831}
    - Verify secure implementation of APIs}\label{lvv-t831}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T832}{LVV-T832}
    - Verify containerized deployment of API services}\label{lvv-t832}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T833}{LVV-T833}
    - Verify support for compression of API results}\label{lvv-t833}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T834}{LVV-T834}
    - Verify API upgradeability}\label{lvv-t834}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T835}{LVV-T835}
    - Verify API logging and monitoring}\label{lvv-t835}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T836}{LVV-T836}
    - Validate ability to identify cool dwarfs via cross-matched survey datasets in LSP}\label{lvv-t836}
...
\subsubsection{Verification Elements}
\begin{itemize}
\item \href{https://jira.lsstcorp.org/browse/LVV-10984}{LVV-10984} - Identify cool dwarfs via cross-matched survey datasets

\end{itemize}

\subsubsection{Test Items}
This test is to validate that an LSP user can identify cool dwarfs (L,
T) through their colors and proper motions by cross-matching data across
surveys. For example, the cross-match may involve 2MASS, DES, SDSS,
WISE, and Gaia data.
...
\subsubsection{Test Procedure}
    ...
    \endhead
            ...
            \multirow{3}{*}{ 1 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            Identify brown dwarfs in WISE data through matching to SDSS colors.
        ...
        \\ \midrule
            ...
            \multirow{3}{*}{ 2 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            Then verify by comparing to the proper motion between 2MASS and WISE.
        ...
        \\ \midrule
            ...
            \multirow{3}{*}{ 3 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            Check to see if original catalog matching may have missed sources
because of the observed proper motion based on the limits of the proper
motions of objects that have been properly matched.
        ...
        \\ \midrule
            ...
            \multirow{3}{*}{ 4 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            Identify new brown dwarfs by matching WISE to DES.
        ...
        \\ \midrule
            ...
            \multirow{3}{*}{ 5 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            Compare to proper motion catalog from Gaia.
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T844}{LVV-T844}
    - Validate separation of stars and galaxies using the Notebook Aspect}\label{lvv-t844}
...
\subsubsection{Verification Elements}
\begin{itemize}
\item \href{https://jira.lsstcorp.org/browse/LVV-10985}{LVV-10985} - Separate stars and galaxies using photometry and morphology

\end{itemize}

\subsubsection{Test Items}
This test is to validate that an LSP user in the Notebook Aspect can use
available photometry and morphology measurements to do star/galaxy
separation.
...
\subsubsection{Test Procedure}
    ...
    \endhead
            ...
            \multirow{3}{*}{ 1 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            i) Plot separate color-color diagrams for extendedness = 0 and high
extendedness objects. Use tools such as a 2D histogram and a contour map
to compare the distributions from overlaid datasets.\\
ii) Overlay a predict stellar locus from a reference model. E.g.,
Davenport 2014.\\
iii) Compare how the galaxies and stars are distributed at different
values of Galactic (l, b). See if the galaxy contours or stellar locus
move. Compare the degree to which they move together and separately.
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T845}{LVV-T845}
    - Validate separation of stars and galaxies using the Portal Aspect}\label{lvv-t845}
...
\subsubsection{Test Items}
This test is to validate that an LSP user in the Portal Aspect can use
available photometry and morphology measurements to do star/galaxy
separation.
...
\href{https://jira.lsstcorp.org/browse/LVV-10984}{LVV-10984 - Identify cool dwarfs via cross-matched survey datasets
}
& {
\hyperref[lvv-t836]{LVV-T836}
} \\
\href{https://jira.lsstcorp.org/browse/LVV-10985}{LVV-10985 - Separate stars and galaxies using photometry and morphology
}
& {
\hyperref[lvv-t844]{LVV-T844}
\hyperref[lvv-t845]{LVV-T845}
