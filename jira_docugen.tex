...
container containing the correct stack version.
        ...
        \\ \midrule
            ...
            \multirow{3}{*}{ 3 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            Access the interactive Python environment by:\\
1) creating a new launcher by clicking the '+' symbol in the upper left
of the UI\\
2) choosing the icon that says "LSST" from the notebook section
...
im = afw\_image.Image(10, 10)\\
isinstance(im, lsst.afw.ImageF)
 }
                \vspace{\dp0}
                } \end{minipage} \\ \cline{2-3}
            & Expected Result &
