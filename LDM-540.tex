...
\setDocAbstract {
This document describes the detailed test specification for the \product{}.  It is a work in progress; 
the current version provides Test Cases covering all requirements on the \product{},  however only $\approx$~10\% are currently fully specified. 
This document will be updated as work continues on completing Test Cases, Test Plans, and requirements coverage.
}

% Most recent last
\setDocChangeRecord{%
s	\addtohist{1.0}{2018-05-01}{Adopted under \jira{RFC-468}.  Used to drive test LSP--00.}{G. P. Dubois-Felsmann}
...
This document provides the test specification for the \product{}. It is a work in progress; 
the current version provides placeholders for all Test Cases, covering all requirements on the \product{},  however only $\approx$~10\% are currently fully specified. 
This document will be updated as work continues on completing Test Cases, Test Plans, and requirements coverage.
